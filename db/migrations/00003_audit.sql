...
-- The table is owned by internal/core/audit; sqlc reads it through
-- db/query/audit.sql (internal/core/audit/repository) via the
-- consolidated schema that schemagen derives from these migrations.
