...
-- name: CreatePatientIdentifier :exec
-- No RETURNING: the id is generated by the application, and the
-- statement must surface constraint errors verbatim (the dqlite driver
-- truncates them on the query path).
