...
func SeedInitialData(ctx context.Context, client *ent.Client) error {
	...
	systems := []struct {
		...
		{uuid.MustParse("00000000-0000-7000-8000-000000000011"), urn.Identifier("br", "cpf"), "CPF (Brasil)", "[0-9]{11}", identifiersystem.TransformDigits, identifiersystem.CheckAlgorithmMod11Desc, 9, 2, 10, true, "000.000.000-00"},
		{uuid.MustParse("00000000-0000-7000-8000-000000000012"), urn.Identifier("br", "sus"), "Cartão SUS (Brasil)", "[0-9]{15}", identifiersystem.TransformDigits, identifiersystem.CheckAlgorithmMod11Cyclic, 14, 1, 10, true, "000 0000 0000 0000"},
		{uuid.MustParse("00000000-0000-7000-8000-000000000013"), urn.Identifier("pt", "nif"), "NIF (Portugal)", "[0-9]{9}", identifiersystem.TransformDigits, identifiersystem.CheckAlgorithmMod11Desc, 8, 1, 9, true, "000 000 000"},
		{uuid.MustParse("00000000-0000-7000-8000-000000000014"), urn.Identifier("passport"), "Passaporte", "[A-Z]{1,2}[0-9]{6,9}", identifiersystem.TransformUpper, identifiersystem.CheckAlgorithmNone, 0, 1, 10, true, ""},
	}
