...
// through window rather than relying on the newer globalThis binding.
// This module must be imported before the SSE extension and before the
// application code (core.ts reads the global and configures it).
