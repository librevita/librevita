...
func (_q *RoleQuery) QueryClinic() *ClinicQuery {
...
func (_q *RoleQuery) FirstID(ctx context.Context) (id ident.RoleID, err error) {
	var ids []ident.RoleID
...
func (_q *RoleQuery) FirstIDX(ctx context.Context) ident.RoleID {
...
func (_q *RoleQuery) OnlyID(ctx context.Context) (id ident.RoleID, err error) {
	var ids []ident.RoleID
...
func (_q *RoleQuery) OnlyIDX(ctx context.Context) ident.RoleID {
...
func (_q *RoleQuery) IDs(ctx context.Context) (ids []ident.RoleID, err error) {
...
func (_q *RoleQuery) IDsX(ctx context.Context) []ident.RoleID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoleQuery) WithClinic(opts ...func(*ClinicQuery)) *RoleQuery {
	query := (&ClinicClient{config: _q.config}).Query()
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withClinic; query != nil {
		if err := _q.loadClinic(ctx, query, nodes, nil,
			func(n *Role, e *Clinic) { n.Edges.Clinic = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *RoleQuery) loadClinic(ctx context.Context, query *ClinicQuery, nodes []*Role, init func(*Role), assign func(*Role, *Clinic)) error {
	ids := make([]ident.ClinicID, 0, len(nodes))
	nodeids := make(map[ident.ClinicID][]*Role)
	for i := range nodes {
		fk := nodes[i].ClinicID
...
func (_q *RoleQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Role, init func(*Role), assign func(*Role, *User)) error {
	...
	nodeids := make(map[ident.RoleID]*Role)
	for i := range nodes {
...
func (_q *RoleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withClinic != nil {
			_spec.Node.AddColumnOnce(role.FieldClinicID)
		}
	}
