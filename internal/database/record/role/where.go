...
func ClinicID(v ident.ClinicID) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldClinicID, v))
}
...
// IsClinical applies equality check predicate on the "is_clinical" field. It's identical to IsClinicalEQ.
func IsClinical(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldIsClinical, v))
}

// ClinicIDEQ applies the EQ predicate on the "clinic_id" field.
func ClinicIDEQ(v ident.ClinicID) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldClinicID, v))
}

// ClinicIDNEQ applies the NEQ predicate on the "clinic_id" field.
func ClinicIDNEQ(v ident.ClinicID) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldClinicID, v))
}

// ClinicIDIn applies the In predicate on the "clinic_id" field.
func ClinicIDIn(vs ...ident.ClinicID) predicate.Role {
	return predicate.Role(sql.FieldIn(FieldClinicID, vs...))
}

// ClinicIDNotIn applies the NotIn predicate on the "clinic_id" field.
func ClinicIDNotIn(vs ...ident.ClinicID) predicate.Role {
	return predicate.Role(sql.FieldNotIn(FieldClinicID, vs...))
}
...
// IsClinicalEQ applies the EQ predicate on the "is_clinical" field.
func IsClinicalEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldIsClinical, v))
}

// IsClinicalNEQ applies the NEQ predicate on the "is_clinical" field.
func IsClinicalNEQ(v bool) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldIsClinical, v))
}

// HasClinic applies the HasEdge predicate on the "clinic" edge.
func HasClinic() predicate.Role {
...
func HasClinicWith(preds ...predicate.Clinic) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := newClinicStep()
